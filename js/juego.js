 ...
 var instrucciones = ["Bienvenido al rompecabezas de BT21, logra formar la imagen que ves aqui abajo",
                      "Mueve con las flechas de tu teclado las piezas!!! No te rindas",];
    ...
    function almacenaDirecciones(direccion){
    ...
    function mostrarCartelGanador() {
        //COMPLETAR
        alert("FELICITACIONES!!! GANASTE EL JUEGO DE BT21");
    }
